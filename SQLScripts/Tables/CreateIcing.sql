...
VALUES ('American ButterCream', 'A combination butter, confectioners sugar, cream, salt and your caramel flavoring.', '150'),
    ...
    ('Blueberry Buttercream', 'Light, smooth and not too sweet, blueberry buttercream is made by heating egg whites and granulated sugar, whipping the mixture to stiff peaks and slowly adding butter and a blueberry sauce.', '150'),
    ...
    ('Gluten Free Frosting', 'Gluten free Frosting', 100);
    ('Orange Frosting', 'Orange Frosting', 100);
