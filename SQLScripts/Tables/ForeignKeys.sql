...
ALTER TABLE [dbo].[Cake] ADD CONSTRAINT [FK_Cake_ToppingID] FOREIGN KEY (ToppingID) REFERENCES [dbo].[Topping] ([ToppingID]);
ALTER TABLE [dbo].[Cake] ADD CONSTRAINT [FK_Cake_ShapeID] FOREIGN KEY (ShapeID) REFERENCES [dbo].[Shape] ([ShapeID]);
...
ALTER TABLE [dbo].[Delivery] ADD CONSTRAINT [fk_Delivery_DeliveryLocationID] FOREIGN KEY([DeliveryLocationID]) REFERENCES [dbo].[Location] ([LocationID]);
